...
byte setTemp = 20;            /* desired temperature */
    ...
    switch (climaState)
    {
        ...
        case STATE_ON_COOL:
        {
            ...
            if(lastState =! climaState){
                ...
                setCoolElement(ON);
                setHeatElement(OFF);
                int diferenta = inTemp - setTemp;
                switch(diferenta) {
                    case 1:
                        fanSpeedHeatVent = 1;
                        setSpeedFanCool(fanSpeedHeatVent);
                        break;
                    case 2:
                         fanSpeedHeatVent = 2;
                        setSpeedFanCool(fanSpeedHeatVent);
        ...
        case STATE_ON_HEAT:
        {
            ...
            if(lastState =! climaState){
                ...
                setHeatElement(ON);
                setCoolElement(OFF);
                int diferenta = setTemp - inTemp;
                switch(diferenta) {
                    case 1:
                        setSpeedFanHeatVent(1);
                        break;
                    case 2:
                        setSpeedFanHeatVent(2);
                        break;
                    case 3:
                        setSpeedFanHeatVent(3);
                        break;
                    case 4:
                        setSpeedFanHeatVent(4);
                        break;
                    default:
                        setSpeedFanHeatVent(5);
                        break;
                }
            }
            if(leftButtonEv == 1){
